...
//	);
     ...
     * @throws Main\SystemException
     */
    protected function obtainProps(array &$cached): void
    {
		if (empty($this->dbResult["ID"]))
			return;
	 ...
	 *
	 */
	protected function obtainDataBasket(): void
    {
	 ...
	 * @return void
	 */
	protected function formatResultUrls(): void
    {
	 ...
	 * @return void
	 */
	protected function formatResultPrices(): void
    {
		...
		{
			$arResult["CAN_CANCEL"] = (($arResult["CANCELED"]!="Y" && $arResult["STATUS_ID"]!="F") ? "Y" : "N");
		}
	 ...
	 * @return void
	 */
	protected function formatResultStatus(): void
    {
		$arResult =& $this->arResult;
	 ...
	 * @return void
	 */
	protected function formatResultUser(): void
    {
		$arResult =& $this->arResult;
	 ...
	 * @return void
	 */
	protected function formatResultPerson(): void
    {
		$arResult =& $this->arResult;
     ...
     * @throws Main\SystemException
     */
	protected function formatResultBasket(): void
    {
		$arResult =& $this->arResult;
	 ...
	 * @return void
	 */
	protected function formatDate(&$arr): void
    {
	 ...
	 * @return boolean
	 */
	public static function cameFromCatalog($item): bool
    {
	 ...
	 * @return void
	 */
	public static function changeBodyEncoding($content): void
	{
	 ...
	 * @return void
	 */
	final protected function endCache($data = false): void
    {
		if(!$this->getCacheNeed())
			return;
	 ...
	 */
	final protected function getCacheKey(array $cacheId = []): string
    {
		if(!is_array($cacheId))
