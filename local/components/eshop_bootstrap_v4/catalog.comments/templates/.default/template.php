...
<?php
	$x=0;
		//для аяска пробрасывается таким образом
	$_SESSION['IBLOCK_CATALOG_COMMENTS_PARAMS_'.$arResult['ELEMENT']["IBLOCK_ID"].'_'.$arResult['ELEMENT']['ID'].'_WAS_BOUGHT'] = $arParams['WAS_BOUGHT'];
?>
<script type="text/javascript">
