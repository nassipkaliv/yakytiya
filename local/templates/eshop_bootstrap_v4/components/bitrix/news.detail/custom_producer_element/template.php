...
//а может и не надо - вдруг стандартный слайдер подойдёт?
//$sellerData = \CU_Seller_Helper::getSellerData($arResult['ID']);
//\CU_Seller_Helper::displayMorePhotos($sellerData['MORE_PHOTOS']);
?>
