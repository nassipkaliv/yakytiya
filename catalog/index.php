...
?>
<?php
//http://127.0.0.8/catalog/e327/
?>
<?

$iblockId = 6;  //новый каталог для Якутии
if ($_GET['old'] == 1 ) {   //способ посмотреть старый каталог, который из коробки битрикса
	$iblockId = 2;
}
...
//		"CACHE_TYPE" => "A",
		...
		"SEF_URL_TEMPLATES" => array(
			...
			"compare" => "compare/",
			"smart_filter" => "s#SECTION_ID#/filter/#SMART_FILTER_PATH#/apply/",
		),
		'SALT'=>'10'
	),
	false
